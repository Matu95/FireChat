    ...
    <div align="center">
        ...
        <div v-if="page == 1">
            <form @submit.prevent="SignUpPassOne()">
                ...
                <p><input type="password" class="input" placeholder="***************" v-model="newUser.repeatpassword">
                </p>
                    ...
                    <div class="col-md-6" style="margin-top: 25px">
                        <div class="Image-input">
                            ...
                            <div class="Image-input__input-wrapper">Buscar imagen
                                <input @change="previewThumbnail" class="Image-input__input" name="thumbnail"
                                       type="file">
                            </div>
                        </div>
                    </div>
            ...
            SignUpPassOne() {
                if (this.newUser.password == this.newUser.repeatpassword) {
                    firebase.auth().createUserWithEmailAndPassword(
                        ...
                        this.page = 2;
                        this.newUser = {};
                        notifications_sucess('Se registro correctamente!');
                    }).catch(error => {
                    ...
                    notifications_error('Las contraseñas no coinciden');
                }
            },
            SignUpPassTwo() {
                database.ref('/users').push({
                    ...
                    notifications_sucess('Te registraste exitosamente, Muchas gracias!');
